...
$routes->resource('pendapatan', ['filter' => 'cors']);
$routes->resource('presensiinstruktur', ['filter' => 'cors']);
$routes->resource('historymember', ['filter' => 'cors']);
$routes->resource('historyinstruktur', ['filter' => 'cors']);
